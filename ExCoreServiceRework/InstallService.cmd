...
@SET ExCoreServiceReworkLocation=
...
call :ColorText 2F "======================================================================================================================="
echo(
call :ColorText 0a "Searching Folder of ExCoreServiceRework=" && <nul set /p=%~dp0%ExCoreServiceReworkLocation%
echo(
IF EXIST %~dp0%ExCoreServiceReworkLocation%\NUL (
  call :ColorText 0e "                                             Folder found" && <nul set /p=":)"
  echo(
  cd %~dp0%ExCoreServiceReworkLocation%
  ExCoreServiceRework.exe install start
